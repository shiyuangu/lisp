;;; sgu: taken from https://www.dr-qubit.org/emacs-misc/show-point-mode.el
...
;; sgu: 5 is the padding if the point if the display width is less than 5
;; Cf: https://www.gnu.org/software/emacs/manual/html_node/elisp/Mode-Line-Data.html
